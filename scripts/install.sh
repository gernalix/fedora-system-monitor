...
install -d -m 0755 /etc/systemd/system/fedora-system-monitor-collect@hourly.service.d
install -m 0644 "$ROOT/systemd/fedora-system-monitor-collect@hourly.service.d/10-nvme-capability.conf" /etc/systemd/system/fedora-system-monitor-collect@hourly.service.d/

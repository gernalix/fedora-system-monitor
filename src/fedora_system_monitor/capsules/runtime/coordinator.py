...
def execute(args: argparse.Namespace) -> int:
    ...
    Argument parsing and user-facing error formatting intentionally remain in
    :mod:`fedora_system_monitor.app`; this capsule owns every runtime side
    effect and coordination decision.
    """
    ...
    try:
        ...
        _print(output, args)
        return 1 if isinstance(output, dict) and output.get("passed") is False else 0
    finally:
        db.close()
